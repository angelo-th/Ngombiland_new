        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <p class="text-gray-600">Transférez vos fonds vers votre compte Mobile Money</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-medium text-green-900">Solde Disponible</h3>
                        <p class="text-3xl font-bold text-green-600">{{ number_format(auth()->user()->wallet->balance ?? 0) }} FCFA</p>
                    </div>
            ...
            <form method="POST" action="{{ route('payments.withdraw') }}" id="withdrawForm">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" id="amount" name="amount" 
                                   ...
                                   placeholder="25000" min="1000" step="100" max="{{ auth()->user()->wallet->balance ?? 0 }}" required>
                    ...
                    <!-- Méthode de retrait -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-3">Méthode de retrait</label>
                        <div class="space-y-3">
                            <div class="flex items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                ...
                                <label for="mtn" class="ml-3 flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Retrait vers MTN MoMo</p>
                                    </div>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                ...
                                <label for="orange" class="ml-3 flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Retrait vers Orange Money</p>
                                    </div>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                ...
                                <label for="express" class="ml-3 flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Retrait vers Express Union</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="border-t border-gray-200 pt-2">
                                <div class="flex justify-between">
                                    <span class="text-gray-900 font-medium">Total débité:</span>
                                    <span class="font-bold text-lg" id="total-display">0 FCFA</span>
                                </div>
                            </div>
                            <div class="flex justify-between text-green-600">
                                <span class="font-medium">Montant reçu:</span>
                                <span class="font-bold" id="received-display">0 FCFA</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <button type="submit" 
                                class="flex-1 bg-red-600 text-white py-3 px-6 rounded-lg hover:bg-red-700 transition-colors">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Le montant minimum de retrait est de 1 000 FCFA</li>
                            <li>Les frais de transaction sont de 1% du montant (minimum 100 FCFA)</li>
                            <li>Les fonds seront transférés dans les 24 heures</li>
                            <li>Assurez-vous que votre numéro de téléphone est correct</li>
                            <li>Vous devez avoir suffisamment de fonds pour couvrir les frais</li>
                        </ul>
                    </div>
                </div>
            </div>
...
function updateSummary() {
    ...
    if (total > maxAmount) {
        document.getElementById('amount').setCustomValidity('Montant insuffisant pour couvrir les frais');
        return;
    } else {
    ...
    document.getElementById('received-display').textContent = new Intl.NumberFormat('fr-FR').format(received) + ' FCFA';
}
